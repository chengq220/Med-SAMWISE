...
from datasets.categories import endovis2017_category_verb_dict as endo_2017_dict, endovis2018_category_verb_dict as endo_2018_dict
...
class EndoVisDataset(Dataset):
    ...
    def prepare_metas(self):
        ...
        for vid_name in self.videos:
            ...
            for frame_id in range(0, vid_len, self.num_frames): # Get each frame
                ...
                neg_cls_size = 1
                for i in range(neg_cls_size): # negative classes
                    meta = {}
                    meta['video'] = vid_name
                    meta['frames'] = vid_frames
                    meta['frame_id'] = frame_id
    ...
    def __getitem__(self, idx):
            ...
            if(cls > 0):
                cap = endo_2018_dict.get(cls, 'Ultrasound Probe scanning and imaging')
            else:
                cap = "No Tools Present"
...
def build(image_set, args):
    ...
    dataset = EndoVisDataset(img_folder, transforms=make_transforms(args.max_size),
